...
## ([main branch](https://github.com/VigneshLoganathanRamesh/securenotes) --> vulnerable code && [securecode branch](https://github.com/VigneshLoganathanRamesh/securenotes/tree/secure-code) --> security issue fixed code).
